...
public class PersonUtils {
    ...
    private static final String FIRST_NAME = "Percy";
    private static final String LAST_NAME = "Jackson";
    private static final String CPF_NUMBER = "102.206.004-06";
    private static final long PERSON_ID = 1L;
    public static final LocalDate BIRTH_DATE = LocalDate.of(1993, 8, 18);

    public static PersonDTO createFakeDTO() {
        return PersonDTO.builder().firstName(FIRST_NAME).lastName(LAST_NAME).cpf(CPF_NUMBER).birthDate("18-08-1993")
